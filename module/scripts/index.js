...
$(function() {
  ...
  $('#btn_submit').click(function() {
    ...
    if (url == '' && file != '') {
      ...
      //httpMethod = "GET"; //should be get here otherwise service will
      //not parse parameter download service does not need to parse upload
      //param in this case as file param is null.
    }
